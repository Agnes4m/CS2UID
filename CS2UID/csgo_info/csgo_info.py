...
from ..utils.csgo_font import csgo_font_30, csgo_font_42,csgo_font_20
...
async def draw_csgo_info_img(detail: UserDetailData) -> bytes | str:
    ...
    rank_img = Image.open(TEXTURE / "base" / "rank_logo.png").convert("RGBA").resize((100,120))
    ...
    main2_draw.text((260, 80), f"{detail['avgWe']:.1f}", (255, 255, 255, 255), csgo_font_42,"mm")
    main2_draw.text((415, 80), f"{detail['rating']:.2f}", (255, 255, 255, 255), csgo_font_42,"mm")
    main2_draw.text((570, 80), f"{detail['rws']:.2f}", (255, 255, 255, 255), csgo_font_42,"mm")
    main2_draw.text((725, 80), f"{detail['adr']:.2f}", (255, 255, 255, 255), csgo_font_42,"mm")
    main2_draw.text((880, 80), f"{detail['entryKillRatio']* 100 :.2f}%", (255, 255, 255, 255), csgo_font_42,"mm")
    main2_draw.text((105, 230), str(rank_scoce), (255, 255, 255, 255), csgo_font_42,"mm")
    main2_draw.text((260, 230), str(detail['cnt']), (255, 255, 255, 255), csgo_font_42,"mm")
    main2_draw.text((415, 230), f"{detail['winRate']* 100 :.1f}%", (255, 255, 255, 255), csgo_font_42,"mm")
    main2_draw.text((570, 230), f"{detail['kd']:.2f}", (255, 255, 255, 255), csgo_font_42,"mm")
    main2_draw.text((725, 230), f"{detail['headShotRatio']* 100 :.1f}%", (255, 255, 255, 255), csgo_font_42,"mm")
    main2_draw.text((880, 230), f"{detail['mvpCount']}", (255, 255, 255, 255), csgo_font_42,"mm")
    ...
    for i in range(min(4, len(detail['hotMaps']))):
        ...
        map_draw.text((110, 100), usr_map['mapName'], (255, 255, 255, 255), csgo_font_20,"mm")
        map_draw.text((180, 80), str(usr_map['totalMatch']), (255, 255, 255, 255), csgo_font_30,"mm")
        map_draw.text((180, 120), "场次", (255, 255, 255, 255), csgo_font_20,"mm")
        map_draw.text((240, 80), f"{usr_map['winCount'] / usr_map['totalMatch']*100 :.1f}%", (255, 255, 255, 255), csgo_font_30,"mm")
        map_draw.text((240, 120), "胜率", (255, 255, 255, 255), csgo_font_20,"mm")        
        map_draw.text((350, 80), f"{usr_map['ratingSum']/ usr_map['totalMatch']:.2f} / {usr_map['totalAdr']/ usr_map['totalMatch']:.0f}", (255, 255, 255, 255), csgo_font_30,"mm")
        map_draw.text((350, 120), "RT/ADR", (255, 255, 255, 255), csgo_font_20,"mm")           
        if i % 2 == 0:
            site_x = 20
        else:
            site_x = 520
    ...
    for i in range(min(8, len(detail['hotWeapons2']))):
        ...
        weapon_draw.text((77, 17), usr_weapon['nameZh'], (255, 255, 255, 255), csgo_font_20,"mm")
        weapon_draw.text((204, 60), str(usr_weapon['killNum']), (255, 255, 255, 255), csgo_font_20,"mm")
        weapon_draw.text((375, 60), f"{usr_weapon['avgTimeToKill']}ms", (255, 255, 255, 255), csgo_font_20,"mm")
        if usr_weapon['sprayAccuracy'] is None:
            weapon_draw.text((285, 60), f"{usr_weapon['firstShotAccuracy']* 100:.2f}%", (255, 255, 255, 255), csgo_font_20,"mm")
        else:
            weapon_draw.text((285, 60), f"{usr_weapon['sprayAccuracy']* 100 :.2f}%", (255, 255, 255, 255), csgo_font_20,"mm")
    ...
    if len(score_list) > 0:
        ...
        draw.line([(padding, padding), (padding, height - padding)], fill='black')  # Y轴
